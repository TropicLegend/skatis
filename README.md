...
* Es können Turniere verwaltet werden
  ...
  * Es werden zwei Passwörter zur Verwaltung benötigt
    * Das Adminpasswort: Nutzer kann im Nachhinein Listen modifizieren, ggf. korrigieren und löschen - und außerdem Listen für die Vergangenheit erstellen. Nutzer kann Zeitraum in der Woche setzen/ändern in der andere Nutzer Listen erstellen und abgeben können - und dabei je Spieltag optional eine Uhrzeit (von bis) festlegen. Nutzer kann Tisch- und Seriennummer einer Liste korrigieren, falls sich ein Mitglied vertan hat. Nutzer kann das normale Passwort neu setzen.
  ...
  * Die Zurück-Taste des Browsers bleibt in der App: von einer Liste zur Übersicht, von der Spieler-Seite zur Rangliste, und offene Dialoge schließen sich damit – aus der Website heraus führt sie nicht mehr. Nach einem Neuladen steht die zuletzt geöffnete Liste wieder da.
